# Angular Boot Camp example: routed-component-inputs
...
**[StackBlitz for routed-component-inputs](https://stackblitz.io/github/AngularBootCamp/routed-component-inputs)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/routed-component-inputs.git
cd routed-component-inputs
npm install
npm start
```
